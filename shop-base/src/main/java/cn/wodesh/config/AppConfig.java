...
public class AppConfig {
    ...
    public final static String FASTMEIL_KEY = "FASTMEIL_";
    public final static Long FASTMEIL_KEY_OUT_LIMIT = 5 * 60L;
    public final static Long ORDER_NO_PAY_OUT_TIME = 5 * 60L;
